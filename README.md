...
## О проекте
Модель машинного обучения для предсказания стоимости единицы площади недвижимости в Тайбэе по 6 характеристикам: возраст дома, расстояние до метро, количество магазинов в пешей доступности, широта, долгота, дата сделки.
